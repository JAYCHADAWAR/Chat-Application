...
function myFunction() {
  ...
  function sendMessage() {
    ...
    console.log("hbdhe");
    document.getElementById('msger-chat').scrollTop +=400;
    // append your own message
    var msgarea=document.getElementById("msger-chat");
    var html= "<div class='msg right-msg' id='rm'>"+
    "<div class='msg-img'></div>"+
    "<div class='msg-bubble'>" +
       "<div class='msg-info'>"+
            "<div class='msg-info-name'>"+sender_name+"</div>"+
            "<div class='msg-info-time'>"+today.getHours()+":"+today.getMinutes()+"</div>"+
        "</div>"+
...
socket.on("new_message", function (data) {
    ...
    var html= "<div class='msg left-msg' id='rm'>"+
    "<div class='msg-img'></div>"+
    "<div class='msg-bubble'>" +
       "<div class='msg-info'>"+
